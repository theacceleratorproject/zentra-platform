...
const translations = {
  fr: {
    ...
    accounts: {
      ...
      closing:        "Fermeture...",
      closedSuccess:  "Compte clôturé avec succès",
    ...
    transactions: {
      ...
      processNote:    "Applique les transactions approuvées et met à jour les soldes",
      results:        "Résultats",
  ...
  en: {
    ...
    accounts: {
      ...
      closing:        "Closing...",
      closedSuccess:  "Account closed successfully",
    ...
    transactions: {
      ...
      processNote:    "Applies approved transactions and updates account balances",
      results:        "Results",
